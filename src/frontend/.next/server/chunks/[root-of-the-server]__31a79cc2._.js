...
"[project]/.next-internal/server/app/api/interviews/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "c601846948721338144fed9697801a8605e640649ff62fe5e6c24fd979aa84de",
    "copyEngine": true
};
...
"[project]/src/app/api/interviews/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const interview = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].interview.create({
        data: {
            title: body.title,
            role: body.role,
            type: body.type,
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(interview);
}
async function GET(req) {
    ...
    const timeEstimate = searchParams.get('timeEstimate');
    ...
    if (timeEstimate) filters.timeEstimate = timeEstimate;
    if (tags) filters.tags;
    const interviews = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].interview.findMany({
        where: filters
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(interviews);
}
}}),

};

//# sourceMappingURL=%5Broot-of-the-server%5D__31a79cc2._.js.map